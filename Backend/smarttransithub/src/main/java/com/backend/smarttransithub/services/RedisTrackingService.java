...
public class RedisTrackingService {
	...
	public Double checkGeofence(Long tripId, Long routeId, Long nextStopId, String stopName, String busNumber,
			double buslat, double buslng) {
		String geoKey = "route:stops:geo:" + routeId;

		// Calculate the distance in meters between bus and the next stop using Redis
		// GEO commands.
